...
const steps = [
  ...
  },
  {
    num: '02',
    title: 'Process',
    desc: 'Zylo analyzes your content and generates structured notes, flashcards, and a study timeline.',
    icon: Brain,
  },
  {
    num: '03',
        ...
        <div className="landing-nav-inner">
          <div className="landing-nav-brand">
            <div className="landing-nav-logo">
              <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" className="text-black"><path d="M4 4h16L4 20h16" strokeLinecap="round" strokeLinejoin="round"/></svg>
            </div>
            <span className="landing-nav-title">Zylo</span>
          </div>
      ...
      <section ref={heroRef} className="landing-section landing-hero relative overflow-hidden">
        ...
        >
          ...
          >
            ...
            flashcards, and adaptive quizzes — all generated by Zylo in seconds.
          </motion.p>
        ...
        <div className="landing-section-inner">
          <RevealSection>
            ...
            <p className="section-subtitle">
              Join thousands of students who are already studying smarter with Zylo.
            </p>
          </RevealSection>
          ...
          <div className="benefits-layout">
            <RevealSection className="benefits-text">
              ...
              <p className="section-subtitle" style={{ textAlign: 'left', maxWidth: '460px' }}>
                Stop wasting hours on manual note-taking. Let Zylo do the heavy lifting so you can
      ...
      <section className="landing-section landing-formats-section">
        <div className="landing-section-inner">
          <RevealSection>
            ...
            <p className="section-subtitle">
              We support all major document formats. Just drag, drop, and let Zylo handle the rest.
            </p>
          </RevealSection>
        ...
        <RevealScale className="landing-section-inner">
          <div className="cta-card">
            ...
            <p className="cta-subtitle">
              Upload your materials, let Zylo structure everything, and start studying in minutes.
            </p>
            <Link href="/auth/signup">
              <motion.button
      ...
      <footer className="landing-footer">
        <div className="landing-footer-inner">
          ...
          <p className="landing-footer-copy">
            &copy; {new Date().getFullYear()} Zylo. Transform material into mastery.
          </p>
        </div>
      </footer>
    </main>
